...
import 'package:flower_ui/entities/bouquet.dart';
...
class WebApiServices {
  ...
  //#region Server
  static String _androidEmulatorLoopback = "localhost";
  ...
  WebApiServices() {
    dio.interceptors.add(
        DioCacheManager(CacheConfig(baseUrl: "https://localhost:5001")).interceptor);
  }
